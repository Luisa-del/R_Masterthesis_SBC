...
#                   verbose = TRUE)
#                   #overwrite = TRUE)
# save(SC_prob, file = paste0("D:/Dateien/Uni/Eagle_Master/Masterthesis/R_Masterthesis_SBC/testing/SC/SC_prob_",x,"_year_stddev.RData"))

load("D:/Dateien/Uni/Eagle_Master/Masterthesis/R_Masterthesis_SBC/testing/SC/SC_prob_L8_reducers_2021_months_8-12_year_stddev.RData")
```
...
# writeRaster(exp1,paste0("D:/Dateien/Uni/Eagle_Master/Masterthesis/R_Masterthesis_SBC/testing/SC/SC_prob_",x,"_year_stddev.tif"))
#
# exp2 <- terra::rast(raw)
# writeRaster(exp2,paste0("D:/Dateien/Uni/Eagle_Master/Masterthesis/R_Masterthesis_SBC/testing/SC/SC_raw_",x,"_year_stddev.tif"))
```
...
df %>%
  ggplot(aes(x = landcover, y = B_median, fill=landcover)) +
...
df %>%
  ggplot(aes(x = landcover, y = BSI_median, fill=landcover)) +
  geom_violin(trim = FALSE,                            # avoid trimming the trails
              draw_quantiles = c(0.25, 0.5, 0.75),     # add quantiles
              alpha = 0.5) +
  geom_boxplot(width = 0.07,position = position_dodge(width = 0.9)) +
...
df %>%
  ggplot(aes(x = landcover, y = NDMI_median, fill=landcover)) +
  geom_violin(trim = FALSE,                            # avoid trimming the trails
              draw_quantiles = c(0.25, 0.5, 0.75),     # add quantiles
              alpha = 0.5) +
  geom_boxplot(width = 0.07,position = position_dodge(width = 0.9)) +
...
df %>%
  ggplot(aes(x = landcover, y = B_stdDev, fill=landcover)) +
  geom_violin(trim = FALSE,                            # avoid trimming the trails
              draw_quantiles = c(0.25, 0.5, 0.75),     # add quantiles
              alpha = 0.5) +
  geom_boxplot(width = 0.07,position = position_dodge(width = 0.9)) +
...
df %>%
  ggplot(aes(x = landcover, y = BSI_stdDev, fill=landcover)) +
  geom_violin(trim = FALSE,                            # avoid trimming the trails
              draw_quantiles = c(0.25, 0.5, 0.75),     # add quantiles
              alpha = 0.5) +
  geom_boxplot(width = 0.07,position = position_dodge(width = 0.9)) +
...
df %>%
  ggplot(aes(x = landcover, y = NDMI_stdDev, fill=landcover)) +
  geom_violin(trim = FALSE,                            # avoid trimming the trails
              draw_quantiles = c(0.25, 0.5, 0.75),     # add quantiles
              alpha = 0.5) +
  geom_boxplot(width = 0.07,position = position_dodge(width = 0.9)) +
